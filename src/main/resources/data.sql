...
-- Corrected INSERT statement using DATEADD for SQL Server, CHANGE THIS WHEN USING MYSQL
INSERT INTO shipments (order_id, delivery_date, status) VALUES
(1, DATEADD(DAY, 3, CURRENT_TIMESTAMP), 'Shipped'),
(2, DATEADD(DAY, 5, CURRENT_TIMESTAMP), 'Processing'),
(3, DATEADD(DAY, 2, CURRENT_TIMESTAMP), 'Delivered'),
(4, DATEADD(DAY, 4, CURRENT_TIMESTAMP), 'Shipped'),
(5, DATEADD(DAY, 6, CURRENT_TIMESTAMP), 'Processing');
